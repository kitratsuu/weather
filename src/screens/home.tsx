    ...
    <div className="h-screen w-screen flex justify-center items-center">
      <div className="space-y-5 h-full w-full flex flex-col justify-center items-center ">
        ...
        <input
          ...
          list="places"
          className="bg-gray-50 border lg:w-96 sm:w-96 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-600 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        />
        <datalist id="places">
          {history.map((e, i) => {
            return (
              <div className="flex" key={i.toString()}>
                <option className="text-white bg-blue-200 hover:bg-blue-100 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-00 dark:hover:bg-blue-200 dark:focus:ring-blue-200">
                  {e.name}
                </option>
              </div>
            );
        ...
        <button
          ...
          className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-slate-500 rounded-full shadow-md group"
        >
